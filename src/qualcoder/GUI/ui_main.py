...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_action_log = QtWidgets.QVBoxLayout(self.tab_action_log)
        self.verticalLayout_action_log.setObjectName("verticalLayout_action_log")
        self.action_log_button_bar = QtWidgets.QFrame(parent=self.tab_action_log)
        self.action_log_button_bar.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.action_log_button_bar.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.action_log_button_bar.setObjectName("action_log_button_bar")
        self.horizontalLayout_action_log = QtWidgets.QHBoxLayout(self.action_log_button_bar)
        self.horizontalLayout_action_log.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_action_log.setObjectName("horizontalLayout_action_log")
        self.pushButton_new_project = QtWidgets.QPushButton(parent=self.action_log_button_bar)
        self.pushButton_new_project.setObjectName("pushButton_new_project")
        self.horizontalLayout_action_log.addWidget(self.pushButton_new_project)
        self.pushButton_open_project = QtWidgets.QPushButton(parent=self.action_log_button_bar)
        self.pushButton_open_project.setObjectName("pushButton_open_project")
        self.horizontalLayout_action_log.addWidget(self.pushButton_open_project)
        self.pushButton_project_memo = QtWidgets.QPushButton(parent=self.action_log_button_bar)
        self.pushButton_project_memo.setObjectName("pushButton_project_memo")
        self.horizontalLayout_action_log.addWidget(self.pushButton_project_memo)
        self.pushButton_settings = QtWidgets.QPushButton(parent=self.action_log_button_bar)
        self.pushButton_settings.setObjectName("pushButton_settings")
        self.horizontalLayout_action_log.addWidget(self.pushButton_settings)
        self.pushButton_help = QtWidgets.QPushButton(parent=self.action_log_button_bar)
        self.pushButton_help.setObjectName("pushButton_help")
        self.horizontalLayout_action_log.addWidget(self.pushButton_help)
        self.horizontalSpacer_action_log = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_action_log.addItem(self.horizontalSpacer_action_log)
        self.verticalLayout_action_log.addWidget(self.action_log_button_bar)
        self.textEdit = QtWidgets.QTextEdit(parent=self.tab_action_log)
        self.textEdit.setObjectName("textEdit")
        self.verticalLayout_action_log.addWidget(self.textEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_new_project.setText(_translate("MainWindow", "Create New Project"))
        self.pushButton_open_project.setText(_translate("MainWindow", "Open Project"))
        self.pushButton_project_memo.setText(_translate("MainWindow", "Project Memo"))
        self.pushButton_settings.setText(_translate("MainWindow", "Settings"))
        self.pushButton_help.setText(_translate("MainWindow", "Contents"))
